...
<!-- Title Spesific -->
@section('title', 'Edit Panduan Tempat')
<!-- /Title Spesific -->

<!-- Page header -->
@section('title-page')
    <a href="/place/"> Pendataan Tempat </a>
    / <a href="/place/{{ $guide->Place->place_id }}"> {{ $guide->Place->title_name }} </a>
    / Panduan Tempat - {{ $guide->GuideType->guide_type_title }}
@endsection
<!-- /page header -->
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form" method="POST" action="{{ route('place.update.guide', $guide->guide_id) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control classification_" name="guide_type_id" required>
                                                ...
                                                @foreach ($guide_type as $gt)
                                                    <option value="{{ $gt->guide_type_id }}" {{ $guide->GuideType->guide_type_id == $gt->guide_type_id ? 'selected':'' }}>
                                                        <div class="col-5">
                                                            <h6>
                                                                <strong>
                                                                    {{ $gt->guide_type_title }}
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="editor1" type="text" name="guide_desc" class="form-control"
                                                placeholder="Masukan deskripsi ..." required>{{ $guide->guide_desc }}</textarea>
