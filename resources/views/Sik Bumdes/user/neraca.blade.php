                            ...
                            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    @php
                                      ...
                                      $sum_ekuitas = 0;
                                    @endphp
                                    @foreach ($assetArray as $assetAry)
                                      <tr>
                                          <td style="width:60%;padding-left: 1.5rem!important;">
                                            <strong>{{$assetAry['classification']}}</strong>
                                          </td>
                                          <td style="width:15%"></td>
                                          <td style="width:15%"></td>
                                          <td style="width:10%"></td>
                                      </tr>
                                        @if (isset($assetAry['name']))
                                          @for ($y = 0; $y < sizeof($assetAry['name']); $y++)
                                            @if ($assetAry['ending balance'][$y] != "0")
                                            <tr>
                                                <td style="width:60%;padding-left: 3rem!important;">
                                                  {{$assetAry['code'][$y]}}- {{$assetAry['name'][$y]}}
                                                </td>
                                                <td style="width:15%">
                                                ...
                                                <td class="text-right" style="width:10%">
                                                  @if ($assetAry['ending balance'][$y] < 0)
                                                    - Rp{{strrev(implode('.',str_split(strrev(strval(-1*$assetAry['ending balance'][$y])),3)))}}  
                                                  @else
                                                    Rp{{strrev(implode('.',str_split(strrev(strval($assetAry['ending balance'][$y])),3)))}}
                                                  @endif
                                                </td>
                                            </tr>
                                            @endif
                                        ...
                                        <tr>
                                          <td style="width:60%;padding-left: 1.5rem!important;">
                                              <b>Total {{$assetAry['classification']}}</b>
                                          </td>
                                          <td style="width:15%"></td>
                                          <td style="width:15%"></td>
                                          <td class="text-right" style="width:10%">
                                            <b>
                                              {{--  {{$assetAry['sum']}}  --}}
                                              @if ($assetAry['sum'] < 0)
                                                - Rp{{strrev(implode('.',str_split(strrev(strval(-1*$assetAry['sum'])),3)))}}  
                                              @else
                                                Rp{{strrev(implode('.',str_split(strrev(strval($assetAry['sum'])),3)))}}
                                              @endif
                                              @php
                                                  $sum += $assetAry['sum'];
                                              @endphp
